...
import { Users, ArrowRight, Sparkles, Code, Cpu, Shield, Smartphone, Globe, Terminal, CheckCircle2 } from 'lucide-react';
...
export const CommunityView: React.FC<CommunityViewProps> = ({ onJoinClick }) => {
  ...
  const domains = [
    ...
    { title: 'UI/UX Design', desc: 'Design systems, user research, and prototyping.', icon: <Sparkles className="w-5 h-5 text-amber-500" /> },
    ...
    { title: 'IoT & Embedded', desc: 'ESP32, sensor meshes, and physical computing.', icon: <Users className="w-5 h-5 text-blue-600" /> },
    { title: 'Data Science', desc: 'Streaming analytics, SQL, Spark, and time-series DBs.', icon: <Code className="w-5 h-5 text-violet-700" /> },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-lg text-slate-600 font-normal leading-relaxed max-w-2xl mx-auto">
            A growing global network for over 5,000 individuals passionate about technology, software engineering, and digital innovation.
          </p>
        ...
        <div className="space-y-12">
          <div className="text-center">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Community Domains</h2>
            <p className="text-sm text-slate-500 mt-2">Specialized discussion channels and study groups within our network.</p>
          </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-3xl p-8 sm:p-12 space-y-8">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Why Join TEKMEN Community?</h2>
            <p className="text-sm text-slate-500 mt-2">A small number of strong benefits designed to accelerate your growth.</p>
          </div>
        ...
        <div className="space-y-12">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">The Community Journey</h2>
            <p className="text-sm text-slate-500 mt-2">From instant collaboration channels to our upcoming dedicated platform.</p>
          </div>
        ...
        <div id="waitlist" className="bg-slate-950 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-2xl space-y-8">
          <div className="max-w-xl mx-auto text-center space-y-3">
            <div className="text-xs font-bold text-blue-400 uppercase tracking-widest">JOIN THE NETWORK</div>
            <h2 className="text-3xl font-black">Become Part of TEKMEN Community</h2>
            <p className="text-slate-400 text-sm">Connect with our active WhatsApp and Discord channels or join the waiting list for our upcoming platform.</p>
          </div>
          ...
          <div className="max-w-md mx-auto pt-6 border-t border-white/10">
            {waitingListSubmitted ? (
              <div className="bg-blue-900/40 border border-blue-500/40 p-4 rounded-xl text-center text-xs text-blue-200">
                You have been added to the waiting list! We'll notify you when the future platform launches.
              </div>
            ) : (
              <form onSubmit={handleWaitingListSubmit} className="flex gap-2">
                <input
                  ...
                  placeholder="Enter your email for platform waiting list"
